...
public:
	 ...
	 *
	 * Typically you shouldn't use this, but the inplace extend method which will
	 * prevent large numbers of allocations.
	 */
	PolytopeCandidate
	 ...
	 *
	 * A pair is returned, (s,e) where s is true if there were no errors and e is
	 * true if the extend method should be called again with the same parameter to
	 * get a different possible answer.
	 */
	bool
